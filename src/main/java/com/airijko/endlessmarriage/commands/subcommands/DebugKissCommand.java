...
/**
 * /marry debug kiss - Run the kiss flow against the active debug NPC.
 * Bypasses marriage and proximity checks. Spawn the NPC first via /marry debug npc.
 */
public class DebugKissCommand extends AbstractPlayerCommand {

    public DebugKissCommand() {
        super("kiss", "Kiss the active debug NPC");
    }
